...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \App\Modules\Users\User|null 
         * @static 
         */
    ...
    class Component extends \Caffeinated\Themes\Facades\Component{
        ...
        public static function register($name, $callback){
            \Caffeinated\Themes\Components::register($name, $callback);
        }
        ...
        public static function exists($name){
            return \Caffeinated\Themes\Components::exists($name);
        }
        ...
        public static function call($name, $parameters = array()){
            return \Caffeinated\Themes\Components::call($name, $parameters);
        }
         ...
         * @static 
         */
        public static function group($name, $components){
            \Caffeinated\Themes\Components::group($name, $components);
        }
        ...
        public static function groupExists($name){
            return \Caffeinated\Themes\Components::groupExists($name);
        }
        ...
        public static function callGroup($name, $parameters = array()){
            return \Caffeinated\Themes\Components::callGroup($name, $parameters);
        }
