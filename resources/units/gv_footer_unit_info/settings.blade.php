<div id="settings_div111">
    ...
    <div class="form-group my_rows1">
        ...
        <div class="col-sm-8">
            {!! BBbutton2('unit',"area2","footer_units","Change",['class'=>'btn btn-default change-layout','data-type'=>'frontend_sidebar','model'=>$settings]) !!}
        </div>
    </div>
    ...
    <div class="form-group my_rows1">
        ...
        <div class="col-sm-8">
            {!! BBbutton('units','area3','Select Unit',['class'=>'form-control input-md','data-sub' => 'general','data-type'=>'backend','model'=>$settings]) !!}
        </div>
    </div>
