                        ...
                        @if (isset($item['children']) and is_array($item['children']))
                            <ul class="nav collapse" id="id{{ $key }}">
                                @foreach ($item['children'] as $child)
                                    <li>
                                        <a href="{{ $child['custom-link'] }}"><span class="title">{{ $child['title'] }}</span>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                ...
                {{--<div class="col-md-8 p-r-0">--}}
                    ...
                    {{--<div>--}}
                        {{--<div id="demo-progress" class="progress">--}}
                            {{--<div role="progressbar" class="progress-bar progress-bar-style" aria-valuenow="30"--}}
                    ...
                    {{--@foreach ($menu_array as $key => $item)--}}
                        ...
                        {{--<li data-toggle="collapse" data-target="#id' . $key . '" class="collapsed">--}}
                            {{--<a href="javascript:void(0)"><i class="' . $icon . '"></i> {{ $item['title'] }}--}}
                                {{--@if (isset($item['children']) and is_array($item['children']))--}}
                                    {{--<span class="pull-right arrow fa fa-arrow-left"></span>--}}
                                {{--@endif--}}
                            {{--</a>--}}
                        {{--</li>--}}
                {{--</ul>--}}
                {{--@if (isset($item['children']) and is_array($item['children']))--}}
                    {{--<ul class="sub-menu collapse" id="id{{ $key }}">--}}
                        {{--@foreach ($item['children'] as $child)--}}
                            {{--<li class="clearfix">' .--}}
