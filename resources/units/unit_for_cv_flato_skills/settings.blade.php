                        ...
                        <div class="content-panel">
                            <div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::text('work['.$key.'][skill_name]', issetReturn($work,'skill_name'),['class'=>'form-control ']) !!}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::text('work['.$key.'][percent]', issetReturn($work,'percent'),['class'=>'form-control ']) !!}
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
...
<div class="bty-settings-panel">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                {!! Form::select('percent_style', $text_styles, null, ['class'=>'form-control'])!!}
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
...
<script>
    ...
    $('#plus').click(function(){
        ...
        $('.exp-panel').append("<div class=\"bty-panel-collapse "+exp_index+"\">\n" +
            ...
            "                                    </div>\n" +
            "                                    <div class=\"col-md-8\">\n" +
            "                                        <input type='text' name='work["+exp_index+"][skill_name]' class='form-control' />\n" +
            "                                    </div>\n" +
            "                                    <div class=\"clearfix\"></div>\n" +
            "                                </div>\n" +
            "                                <div class=\"form-group\">\n" +
            ...
            "                                    </div>\n" +
            "                                    <div class=\"col-md-8\">\n" +
            "                                        <input style='height: 200px' name='work["+exp_index+"][percent]' class='form-control'/>\n" +
            "                                    </div>\n" +
            "                                    <div class=\"clearfix\"></div>\n" +
            "                                </div>\n" +
            "                            </div>\n" +
