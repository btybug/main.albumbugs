<div class="container-fluid">
    <div class="profile-main {{(isset($settings['style'])&& $settings['style'] ) ? $settings['style'] : 'demo-column'}}">
        <section id="skills-flato" class="{{(isset($settings['skill_container_style'])&& $settings['skill_container_style'] ) ? $settings['skill_container_style'] : 'demo-column'}}">
            <div class="container">
                <div class="skills">
                    <div class="heading">
        ...
        <section id="experience-flato" class="{{(isset($settings['exp_container_style'])&& $settings['exp_container_style'] ) ? $settings['exp_container_style'] : 'demo-column'}}">
            <div class="container">
