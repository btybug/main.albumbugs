            ...
            <div role="tabpanel" class="tab-pane general p-10 active" id="general" data-formsetting="setting">
                <div class="form-group"><label for="EditFieldTitle"><i class="fa fa-play mr-5 f-12"></i> Field
                        Title</label><input class="form-control" id="EditFieldTitle" data-field="lable"
                                            placeholder="Text here" value="Redio buttons" type="text">
                </div>
                ...
                <div class="form-group"><label for="EditFieldname"><i class="fa fa-play mr-5 f-12"></i> Field
                        name</label><input class="form-control" id="EditFieldname" data-field="name"
                                           placeholder="Text here" value="optionsRadios" type="text">
                </div>
            </div>
