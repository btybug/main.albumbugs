...
@section('content')
    ...
    <div class="main_lay_cont">
        <div class="row for_title_row">
            <h1 class="text-center">Developers console</h1>
        </div>
        <div class="row layouts_row">
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 items_links">
                <a href="{!! url('admin/console/settings/general') !!}" class="ly_items">
                    <h3>General</h3>
                    <h2><i class="fa fa-cogs" aria-hidden="true"></i></h2>
                </a>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 items_links">
                <a href="{!! url('admin/console/settings/css-js') !!}" class="ly_items">
