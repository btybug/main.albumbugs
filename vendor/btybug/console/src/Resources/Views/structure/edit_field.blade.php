...
@section('CSS')
    <style>
        ...
        .formgeneral .inner-charts {
            margin-bottom: 2em;
        }

        .formgeneral .form-control1 {
        ...
        .formgeneral .forms-main {
            margin-bottom: 2em;
        }

        .formgeneral button, .formgeneral input, .formgeneral select, .formgeneral textarea {
            font-family: inherit;
            font-size: inherit;
            line-height: inherit;
        }

        .formgeneral .form-group.button {
            margin-top: 1em;
            text-align: center;
        }

        .formgeneral .form-group.button > button {
            cursor: pointer;
            margin: 10px;
            border-radius: 0;
        ...
        .formgeneral .form-group.button > button:hover {
            background-color: #00000082;
            color: white;
        }

        .formgeneral label.check {
            padding: 10px 0 0 0;
        }

        .formgeneral input.form-control1.icon {
            padding: 7px 5px;
            margin: 0;
        }

        .formgeneral .input-group-addon:first-child {
            border-right: 0;
            border-radius: 0;
        }

        .formgeneral .input-group-addon:last-child {
            border-left: 0;
            border-radius: 0;
        }
        .formgeneral .tooltip1 {
            position: relative;

        }
        .formgeneral .input-group-addon{
            min-width: 33px;
        }
        .formgeneral .tooltip1 .tooltiptext {
            visibility: hidden;
            width: 120px;
        ...
        .formgeneral .tooltip1 .tooltiptext::after {
            content: "";
            position: absolute;
            top: 100%;
            left: 50%;
        ...
        .formgeneral .tooltip1:hover .tooltiptext {
            visibility: visible;
            opacity: 1;
        }
        /*---responsive-----*/
