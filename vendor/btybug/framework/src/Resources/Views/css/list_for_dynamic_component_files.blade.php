    ...
    <div class="main_lay_cont">
        ...
        <div class="row layouts_row">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 m-t-54">
                @include("framework::css._partials.left_menu_for_dynamic_component")
            </div>
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                @include("framework::css._partials.partial_for_dynamic_component_file")
            </div>
        </div>
    </div>
@stop
    ...
    <script>
        $(document).ready(function(){
            ...
            $("body").delegate(".delete_item_and_classes","click",function(){
                ...
                var url = base_path + "/admin/framework/dynamic-component/reset";
                $.ajax({
                    url: url,
                    data: {
                        slug:slug,
