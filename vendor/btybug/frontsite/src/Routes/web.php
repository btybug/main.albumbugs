...
//        Route::get('/edit/{id}', 'ClassifyController@getEdit');
    ...
    Route::group(['prefix' => 'menus'], function () {
        ...
        Route::get('/edit/{id}', 'MenusController@getEdit')->name('edit_front_menu');
...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::get('/login-registration', 'SettingsController@getLoginRegistration');
    Route::get('/notifications', 'SettingsController@getNotifications');
    Route::get('/url-menger', 'SettingsController@getUrlMenger');
    Route::get('/adminemails', 'SettingsController@getAdminemails');
    Route::get('/lang', 'SettingsController@getLang');
    Route::get('/api-settings', 'SettingsController@getApi');
    Route::post('/page-settings', 'GeneralController@postSettings')->name('front_pages_general_settings');
    Route::get('/frontend', 'SettingsController@getFrontSettings')->name('font_site_settings_frontrnd');
