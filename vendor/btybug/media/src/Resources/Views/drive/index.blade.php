                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content {!! $settings['leftcontainer'] or null !!}">
                            <div class="file-manager">
                                ...
                                <button class="btn btn-primary btn-block {!! $settings['uploadbutton'] or null !!}">
                                    Upload Files
                                </button>
                                <div class="hr-line-dashed"></div>

                                <h5><a class="pull-right {!! $settings['addbutton'] or null !!}" data-toggle="collapse"
                                    ...
                                    <a href="#">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive"
                                                 src="{!! url('media_template/img/p1.jpg')!!}">
                                        </div>
                                        <div class="file-name">
                                            Italy street.jpg
                                            <br/>
                            ...
                            <div class="file-box">
                                <div class="file {!! $settings['thumbnailclass'] or null !!}">
                                    <a href="#">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive"
                                                 src="{!! url('media_template/img/p2.jpg')!!}">
                                        </div>
                                        <div class="file-name">
                                            My feel.png
                                            <br/>
                            ...
                            <div class="file-box">
                                <div class="file {!! $settings['thumbnailclass'] or null !!}">
                                    <a href="#">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive"
                                                 src="{!! url('media_template/img/p3.jpg')!!}">
                                        </div>
                                        <div class="file-name">
                                            Document_2014.doc
                                            <br/>
...
@section('css')
    ...
    {!! Html::style("/media_template/css/style.css") !!}
